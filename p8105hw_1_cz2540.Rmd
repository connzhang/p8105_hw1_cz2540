...
* The logic and factor scatterplots consist of two colors that represent the binary values of true, in blue, and false, in red. The numeric scatterplot is different in that the color scale is a gradient ranging from a darker to lighter blue. This represents the continuous scalae from 0.00 to 1.00 as seen in the output's legend. 